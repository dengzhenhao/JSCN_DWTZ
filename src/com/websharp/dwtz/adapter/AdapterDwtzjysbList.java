...
import com.websharp.dwtz.activity.dwtzjysb.ActivityEditDwtzjysb;
 ...
 * 
 */
public class AdapterDwtzjysbList extends CListView {

	public AdapterDwtzjysbList(PullToRefreshListView lv, Activity activity) {
		super(lv, activity);
...
//						false);
				Bundle b = new Bundle();
				b.putInt("position",i);
				Util.startActivity(mActivity, ActivityEditDwtzjysb.class, b,
						false);
			}
		});
	}
	...
	public void asyncData() {
		super.asyncData();
		new SJECHttpHandler(callback, mActivity).GetSlaughterListByUserID(
				page + "", mPerpage + "");
	}
