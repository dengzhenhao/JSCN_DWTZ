...
public class ActivityAddOrder_bak_20190123 extends BaseActivity {
	...
	ImageView iv_spinner_goodsowner, iv_spinner_origin, iv_spinner_processreason, iv_spinner_processcomment;
	...
	public void onClick(View v) {
		...
		case R.id.iv_camera:
			...
			// b,
			// false);
			Util.startActivity(ActivityAddOrder_bak_20190123.this, ActivityPicSend.class, false);
			break;
		...
		public void onSuccess(String response) {
			...
			try {
				...
				if (obj.optString("result").equals("true")) {
					...
					Util.createToast(ActivityAddOrder_bak_20190123.this,
	...
	AsyncHttpCallBack cb = new AsyncHttpCallBack() {
		...
		public void onSuccess(String response) {
			...
			try {
				...
				if (obj.optString("result").equals("true")) {
					Util.createToast(ActivityAddOrder_bak_20190123.this, R.string.msg_control_success, 3000).show();
	...
	private void AsyncAddOrder() {
		...
		try {
			...
			e.printStackTrace();
			Util.createToast(ActivityAddOrder_bak_20190123.this, R.string.msg_control_failed, 3000).show();
		}
	}
