...
public class GlobalData {
	...
	public static ArrayList<EntityModule> listModule = new ArrayList<EntityModule>();
	...
	public static boolean ContainModule(String moduleName) {
		if (listModule != null) {
			for (int i = 0; i < listModule.size(); i++) {
				if(listModule.get(i).DisplayName.contains(moduleName.trim())){
					return true;
				}
			}
			return false;
